...
class Empleado extends Sistema
{
    ...
    function create($data)
    {
        $result = [];
        $this->conexion();
        $sql = "INSERT INTO empleado(nombre,primer_apellido,segundo_apellido,curp,id_puesto,id_usuario) 
        VALUES (:nombre,:primer_apellido,:segundo_apellido, :curp, :id_puesto, :id_usuario);";
       ...
       // $insertar->bindParam(':email', $data['email'], PDO::PARAM_STR);
        $insertar->bindParam(':id_puesto', $data['id_puesto'], PDO::PARAM_INT);
    ...
    function update($id, $data)
    {
        $result = [];
        $this->conexion();
        $sql = "UPDATE empleado SET nombre=:nombre,primer_apellido=:primer_apellido,segundo_apellido=:segundo_apellido, curp=:curp, id_puesto=:id_puesto, id_usuario=:id_usuario
        ...
        $modificar->bindParam(':id_puesto', $data['id_puesto'], PDO::PARAM_INT);
